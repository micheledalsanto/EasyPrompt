export const suggestionsByRole = {
    ...
    "Specialista SEO": "Genera una lista di parole chiave long-tail per un sito e-commerce di abbigliamento sportivo.",
    ...
    "Specialista Email Marketing": "Progetta una campagna di email automation per il recupero dei carrelli abbandonati in un e-commerce.",
    ...
    "Direttore Artistico": "Coordina il concept creativo per una campagna pubblicitaria multisoggetto per un brand di moda.",
    "Product Designer": "Progetta il flusso utente per la prenotazione di un volo su un'app di viaggio.",
  
    "Insegnante": "Prepara un'esercitazione interattiva sul ciclo dell’acqua per studenti delle scuole medie.",
    ...
    "Ricercatore Accademico": "Progetta un’indagine qualitativa sull’impatto dell’AI nelle scienze sociali.",
    "Tecnologo Educativo": "Sviluppa un piano per introdurre strumenti digitali inclusivi nella didattica scolastica.",
    ...
    "Statistico": "Progetta un esperimento per validare l’efficacia di una campagna di vaccinazione.",
    ...
    "Ingegnere AI": "Progetta un flusso per addestrare un modello NLP su dati di recensioni clienti.",
    ...
    "Consulente Strategico": "Proponi un piano di espansione internazionale per una PMI italiana nel settore food.",
    "Responsabile Operativo": "Ottimizza il processo di approvvigionamento per ridurre i tempi di consegna del 20%.",
  
    "Sales Representative": "Simula una call di vendita con un cliente interessato a una piattaforma di e-learning.",
    "Addetto Assistenza Clienti": "Scrivi una risposta empatica a un cliente che lamenta ritardi nella spedizione.",
    "Account Manager": "Prepara un report mensile per un cliente enterprise con KPI raggiunti e azioni future.",
    "Specialista CRM": "Crea una segmentazione dei clienti per una campagna mirata via email.",
